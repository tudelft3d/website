...
<div class="row featurette">
    <div class="col-sm-6 col-xs-6"><img class="img-responsive" src="{{ "img/texture_zoom_in.jpg" }}">
      <p style="text-align: center;">Figure 3: The input textured mesh (part of our dataset). </p>
    </div>

   <div class="col-sm-6 col-xs-6"><img class="img-responsive" src="{{ "img/semantic_zoom_in.jpg" }}">
...
<div class="col-sm-12 col-xs-12"><img class="img-responsive" src="{{ "img/labeling_workflow.jpg" }}"></div>
...
<div class="col-sm-12 col-xs-12"><img class="img-responsive" src="{{ "img/table_benchmarks.jpg" }}"></div>
...
<div class="col-sm-12 col-xs-12"><img class="img-responsive" src="{{ "img/data_split.jpg" }}"></div>
...
<div class="col-sm-12 col-xs-12"><img class="img-responsive" src="{{ "img/table_comparision.jpg" }}"></div>
...
<div class="row featurette">
  ...
  <div class="col-md-5">
    <img class="img-responsive" src="{{ "img/train_increase.jpg" }}">
