...
<div class="col-sm-12 col-xs-12"><img class="img-responsive" src="{{ "img/mesh_overview_s.png" }}"></div>
...
<div class="col-sm-12 col-xs-12"><img class="img-responsive" src="{{ "img/hel_map_s.jpg" }}"></div>
<p style="text-align: center;">Figure 2: Selected area of Helsinki </p>

<div class="col-sm-12 col-xs-12"><img class="img-responsive" src="{{ "img/texture_zoom_in_s.png" }}"></div>
<p style="text-align: center;">Figure 3: The input textured mesh (part of our dataset). </p>

<div class="col-sm-12 col-xs-12"><img class="img-responsive" src="{{ "img/semantic_zoom_in_s.png" }}"></div>
...
<div class="col-sm-12 col-xs-12"><img class="img-responsive" src="{{ "img/labeling_workflow_s.png" }}"></div>
...
<div class="col-sm-12 col-xs-12"><img class="img-responsive" src="{{ "img/table_benchmarks_s.png" }}"></div>
...
<div class="col-sm-12 col-xs-12"><img class="img-responsive" src="{{ "img/data_split_s.png" }}"></div>
...
<div class="col-sm-12 col-xs-12"><img class="img-responsive" src="{{ "img/table_comparision_s.png" }}"></div>
...
<div class="col-sm-12 col-xs-12"><img class="img-responsive" src="{{ "img/train_increase_s.png" }}"></div>
