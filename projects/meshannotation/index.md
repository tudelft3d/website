...
<div class="col-md-12">
    <img class="featurette-image img-responsive" src="{{ "img/table_benchmarks.jpg" | prepend: site.baseurl }}" alt="Generic placeholder image">
...
<div class="col-md-12">
    <img class="featurette-image img-responsive" src="{{ "img/data_split.jpg" | prepend: site.baseurl }}" alt="Generic placeholder image">
...
<div class="row featurette">
  ...
  <div class="col-md-5">
    <img class="featurette-image img-responsive" src="{{ "img/train_increase.jpg" | prepend: site.baseurl }}" alt="Generic placeholder image">
