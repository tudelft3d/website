...
<div style="padding:5px" class="col-md-4 col-sm-4 col-xs-8">
    <img src="/img/mesh_overview.png" alt="mesh overview" >
...
<div style="padding:5px" class="col-md-4 col-sm-4 col-xs-8">
    <img src="/img/hel_map.jpg" alt="map" >
    <figcaption>Selected area of Helsinki </figcaption>
</div>

<div style="padding:5px" class="col-md-4 col-sm-4 col-xs-8">
    <img src="/img/texture_zoom_in.png" alt="texture_zoom_in" >
    <figcaption>The input textured mesh (part of our dataset). </figcaption>
</div>

<div style="padding:5px" class="col-md-4 col-sm-4 col-xs-8">
    <img src="/img/semantic_zoom_in.png" alt="texture_zoom_in" >
...
<div style="padding:5px" class="col-md-4 col-sm-4 col-xs-8">
    <img src="/img/labeling_workflow.png" alt="labeling_workflow" >
...
<div style="padding:5px" class="col-md-4 col-sm-4 col-xs-8">
    <img src="/img/table_benchmarks.png" alt="map" >
...
<div style="padding:5px" class="col-md-4 col-sm-4 col-xs-8">
    <img src="/img/data_split.png" alt="data_split" >
...
<div style="padding:5px" class="col-md-4 col-sm-4 col-xs-8">
    <img src="/img/table_comparision.png" alt="map" >
...
<div style="padding:5px" class="col-md-4 col-sm-4 col-xs-8">
    <img src="/img/train_increase.png" alt="data_split" >
