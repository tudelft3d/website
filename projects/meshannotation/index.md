...
<div class="col-sm-8 col-xs-8"><img class="img-responsive" src="{{ "img/texture_zoom_in.jpg" }}"></div>
<p style="text-align: center;">Figure 3: The input textured mesh (part of our dataset). </p>
<div class="col-sm-4 col-xs-4"></div>

<div class="col-sm-8 col-xs-8"><img class="img-responsive" src="{{ "img/semantic_zoom_in.jpg" }}"></div>
...
## Data Download
We only provide the data in PLY format, and the semantic classes and colours are defined as follows:
...
<div class="col-sm-10 col-xs-10"><img class="img-responsive" src="{{ "img/labeling_workflow.jpg" }}"></div>
...
<div class="col-sm-8 col-xs-8"><img class="img-responsive" src="{{ "img/data_split.jpg" }}"></div>
...
<div class="col-sm-6 col-xs-6"><img class="img-responsive" src="{{ "img/train_increase.png" }}"></div>
