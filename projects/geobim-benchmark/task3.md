...
### Data
You are able to download the CityGML *open data* from their respective <mark>[description page](https://3d.bk.tudelft.nl/projects/geobim-benchmark/ifcgeometries.html)</mark>
